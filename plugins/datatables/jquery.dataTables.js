...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = "<label id='text_box'>"+sSearchStr+"</label>";
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			nLength.innerHTML = '<label id="row_count">'+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</label>';
