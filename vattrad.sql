...
--
-- Host: localhost
-- Generation Time: Jan 31, 2013 at 05:39 PM
...
('1', '121', 'nitin kumar', 'nk', 'khatav', '', '', 'Khatav', '9028536574', 'q123', 'nitin@gmail.com', 'h567', 'c234', 'as123', 'maharashtra', '1122', 'paresh', '', 'tuesday', '', '', '1', '2', '3', 5),
...
CREATE TABLE IF NOT EXISTS `brand_master` (
  ...
  `sal1` text NOT NULL,
  `ID` int(10) NOT NULL AUTO_INCREMENT,
  `upper_available` text NOT NULL,
  `lower_available` text NOT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `brand_master` (`item_name`, `op_bal_dr`, `op_bal_cr`, `op_bal_pcs`, `op_bal`, `brand_code`, `brand_name`, `op_amnt`, `inventory_control`, `upper`, `lower`, `qty1`, `qty2`, `ul`, `pcs_qty`, `mrp`, `sales_tax`, `type`, `hamali`, `tolai`, `pur`, `sal`, `pur1`, `sal1`, `ID`, `upper_available`, `lower_available`) VALUES
('cake', '0.00', '0.00', '0.00', '0.00', '2', 'chocolate', '0.00', '', 'box', 'pcs', '5', '25', '1 box = pcs', '5.00', '10', '0.00', 'Inclusive', '1.00', '', '45.00', '50.00', '9.00', '10.00', 2, '10', '0'),
('cake', '0.00', '0.00', '0.00', '0.00', '1234', 'blackforest', '0.00', 'u', 'box', 'pcs', '0', '0', '1 box = pcs', '10', '100', '0.00', 'Dependon', '0.00', '0.00', '100', '110', '10', '11', 6, '5', '1');
...
('2012-08-12', 'P_1', '100', '2012-08-12', 'nitin kumar', 'Credit', 'reshama', '2', 'blackforest', 'RD', '10', '10', '0.00', '45.00', '9.00', '450', '1', '1', 'Inclusive', '4.5', '4.455', '441.045', ' Sunday', 5);
...
('321', '2012-08-24', 'seema', 'Cash', 'anuja', '2', 'chocolate', '10', '1', '2', '50.00', '10.00', '70', 'Inclusive', '2', '1.3719999999999999', '2', '1', '2', '1.4', '1', '1', '1', 'Add', '', '0.00', '1', '0.7', '69.3', '60', '9.299999999999997', ' Monday', 1);
